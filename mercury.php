...
$sql = "SELECT * FROM mainplanets WHERE PlanetName='Mercury'";
...
$sql="select FactNumber1, FactNumber2, FactNumber3 FROM funfacts where PlanetName='Mercury'";
$result = $conn->query($sql);
...
$sql="select NoOfMoons FROM moonsoftheplanets where NameOfThePlanet='Mercury'";
$result = $conn->query($sql);
...
<div  style="position: absolute; text-align: center; top: 16%; left: 36%;color: rgb(255, 255, 255);">
	<h1 style="font-family: Arial, Helvetica, sans-serif;  font-size: 80px;"><br> MERCURY</h1>
</div>
...
<div style="position: absolute; left: 38%; top: 72%; font-family: Arial, Helvetica, sans-serif; font-size: 20px;">
	<h1 style="color: blanchedalmond;font-family: Arial, Helvetica, sans-serif; "> Fun facts about Mercury </h1>
	</div>
...
<br>
	...
	<div style="position: absolute; bottom: 1%; left: 43%;  " class="TC" >
	<a href="venus.php">NEXT PLANET</a>
</div>
</section>
