...
$sql = "SELECT * FROM otherbodies WHERE BodyName='433_Eros'";
...
$sql="select FactNumber1, FactNumber2, FactNumber3 FROM funfacts where PlanetName='433_Eros'";
$result = $conn->query($sql);
...
nav img{
	...
	.header1{
		...
		background-image:  url('433_ErosMAIN.gif');
		height: 87vh;
		width: 98vh;
		left: 22%;
		text-align: center; 
...
<div  style="position: absolute; text-align: center; top: 16%; left: 36%;color: rgb(255, 255, 255);">
	<h1 style="font-family: Arial, Helvetica, sans-serif;  font-size: 80px;"><br> 433 Eros</h1>
</div>
...
<div style="position: absolute; left: 38%; top: 72%; font-family: Arial, Helvetica, sans-serif; font-size: 20px;">
	<h1 style="color: blanchedalmond;font-family: Arial, Helvetica, sans-serif; "> Fun facts about 433 Eros </h1>
	</div>
...
<br>
	...
	<a href="243ida.php">PREV PLANET</a>
	<a href="ceres.php">NEXT PLANET</a>
</div>
</section>
