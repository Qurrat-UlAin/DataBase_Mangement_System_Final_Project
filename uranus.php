...
$sql = "SELECT * FROM mainplanets WHERE PlanetName='Uranus'";
...
$sql="select FactNumber1, FactNumber2, FactNumber3 FROM funfacts where PlanetName='Uranus'";
$result = $conn->query($sql);
...
$sql="select NoOfMoons FROM moonsoftheplanets where NameOfThePlanet='Uranus'";
$result = $conn->query($sql);
...
<div class="aa" style="position: absolute; text-align: center; top: 26%; left: 36%;color: rgb(255, 255, 255);">
	<h1 style="position: absolute;  font-family: Arial, Helvetica, sans-serif; font-weight: 1; font-size: 50px; 	"> DESTINATION</h1>
</div>
<div  style="position: absolute; text-align: center; top: 26%; left: 36%;color: rgb(255, 255, 255);">
	<h1 style="font-family: Arial, Helvetica, sans-serif;  font-size: 80px;"><br> Uranus</h1>
</div>
...
<div style="position: absolute; left: 38%; top: 72%; font-family: Arial, Helvetica, sans-serif; font-size: 20px;">
	<h1 style="color: blanchedalmond;font-family: Arial, Helvetica, sans-serif; "> Fun facts about Uranus </h1>
	</div>
...
<br>
	...
	<a href="neptune.php">PREV PLANET</a>
</div>
</section>
