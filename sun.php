...
$sql = "SELECT * FROM central_star WHERE Body_Name='Sun'";
...
if ($result->num_rows > 0) {
 ...
 while($row = $result->fetch_assoc()) {
   ...
   $avgTemp= $row["AverageTemperature"];
   $massSun=$row["Mass_ofTheBody"];
   $sizeSun=$row["Size_ofTheBody"];
...
nav img{
	...
	.header1{
		...
		background-image:  url('SunMAIN.gif');
		height: 87vh;
		width: 98vh;
		left: 22%;
		text-align: center; 
...
<div  style="position: absolute; text-align: center; top: 16%; left: 36%;color: rgb(255, 255, 255);">
	<h1 style="font-family: Arial, Helvetica, sans-serif;  font-size: 80px;"><br> Sun</h1>
</div>
<div style="width: 80%;position: relative; height: 300px; border: 3px solid blanchedalmond;text-align: center; left: 150px;border-radius: 20px; ">
	...
	<div style="position: absolute;font-family: Arial, Helvetica, sans-serif; top: 170px; left: 35%;line-height: 40px;">
		<h1 style="color:blanchedalmond ; font-weight: lighter	; font-size: 18px;">MASS</h1>
		<h1 style="color:blanchedalmond ; font-weight: lighter	; font-size: 20px;"><?php echo $massSun; ?> KGs</h1>
	</div>
	...
	<div style="position: absolute;font-family: Arial, Helvetica, sans-serif; top: 170px; left: 40%;line-height: 40px;">
...
<div style="position: absolute;font-family: Arial, Helvetica, sans-serif; top: 10px; left: 40%;line-height: 40px;">
		<h1 style="color:blanchedalmond ; font-weight: lighter	; font-size: 18px;">SIZE</h1>
		<h1 style="color:blanchedalmond ; font-weight: lighter	; font-size: 30px;"><?php echo $sizeSun; ?> miles</h1>
	</div>
</div>
<br><br><br>
<div style="position: absolute; left: 38%; top: 72%; font-family: Arial, Helvetica, sans-serif; font-size: 20px;">
	<h1 style="color: blanchedalmond;font-family: Arial, Helvetica, sans-serif; "> Fun facts about Sun </h1>
	</div>
